...
def part_1_sample():
    return product([monkey.inspection_counter for monkey in get_n_most_active_monkeys(get_monkeys("Dec11/sample_input.txt"), rounds=20, n=2, worry_level_divisor=3)])

def part_1_answer():
    return product([monkey.inspection_counter for monkey in get_n_most_active_monkeys(get_monkeys("Dec11/input.txt"), rounds=20, n=2, worry_level_divisor=3)])

def part_2_sample():
    return product([monkey.inspection_counter for monkey in get_n_most_active_monkeys(get_monkeys("Dec11/sample_input.txt"), rounds=10000, n=2, worry_level_divisor=1)])

def part_2_answer():
    return product([monkey.inspection_counter for monkey in get_n_most_active_monkeys(get_monkeys("Dec11/input.txt"), rounds=10000, n=2, worry_level_divisor=1)])
